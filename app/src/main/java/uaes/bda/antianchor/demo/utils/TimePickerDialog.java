...
public class TimePickerDialog {
    ...
    public TimePickerDialog(Context context,TextView tvDate) {
        super();
        mContext = context;
//        timePickerDialogInterface = (TimePickerDialogInterface) context;
        this.tvDate = tvDate;
    }
    public TimePickerDialog(Context context,EditText etDate) {
        super();
        mContext = context;
//        timePickerDialogInterface = (TimePickerDialogInterface) context;
        this.etDate = etDate;
...
//    }
    ...
    */
    ...
    private void getDatePickerValue() {
        ...
        String strDate = ((mMonth+1) < 10)?("0"+(mMonth+1)):((mMonth+1)+"");
        String strDay = (mDay < 10)?("0"+mDay):(mDay+"");
        if(tvDate != null){
            tvDate.setText(mYear +"-" + strDate +"-" + strDay);
        }
        if (etDate != null){
            etDate.setText(mYear +"-" + strDate +"-" + strDay);
        }
    }
