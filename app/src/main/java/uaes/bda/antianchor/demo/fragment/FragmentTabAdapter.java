...
public class FragmentTabAdapter implements NestRadioGroup.OnCheckedChangeListener{
    ...
    public FragmentTabAdapter(FragmentActivity fragmentActivity, List<Fragment> fragments, int fragmentContentId, NestRadioGroup rgs) {
...
//
//    }
    public void getRadioGroup(int i, boolean b){
		getRadioGroup(i);
	}
