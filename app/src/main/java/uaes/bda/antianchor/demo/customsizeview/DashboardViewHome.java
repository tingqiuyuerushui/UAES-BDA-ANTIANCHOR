...
public class DashboardViewHome extends View {
    ...
    private String mHeaderText = "剩余油量"; // 表头
    ...
    public DashboardViewHome(Context context) {
        this(context, null);
    }

    public DashboardViewHome(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DashboardViewHome(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.color_dashboard_yellow));
